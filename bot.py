...
async def run_bot():
    ...
    # Use owner session for control bot as fallback or just use bot token with the owner's api id/hash provided in the message.
    control_bot = TelegramClient('bot_control', CONTROL_BOT_API_ID, CONTROL_BOT_API_HASH, **device_props)
